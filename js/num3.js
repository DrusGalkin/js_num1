...
function Click3(){
    ...
    if(num <= 40){
        ...
        document.querySelector('.out3').innerHTML = ('Делай то что говорят придурок');
    }
}
...
function Click4(){
    ...
    if(num2>=41){
        document.querySelector('.out4').innerHTML = ('придурок 2.0');
    }
    else{
        while(i <= num2){
...
function Click5(){
    ...
    if(num3>=41){
        document.querySelector('.out5').innerHTML = ('придурок 3.0');
    }
    else{
        do{
